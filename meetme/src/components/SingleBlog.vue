          ...
          <div class="container">
            <div class="banner_content text-center">
              ...
              <div class="page_link">
                ...
                <router-link :to="{ name: 'Blog' }">وبلاگ</router-link>
            ...
            <div class="single-post row">
              <div class="col-lg-12">
                <div class="feature-img">
                  <img
                    class="img-fluid"
                    src="../../static/assets/img/blog/feature-img1.jpg"
                    alt=""
                  />
                </div>
              </div>
              ...
              <div class="col-lg-12">
                ...
                <div class="row">
                  <div class="col-6">
                    <img
                      class="img-fluid"
                      src="../../static/assets/img/blog/post-img1.jpg"
                      alt=""
                    />
                  </div>
                  <div class="col-6">
                    <img
                      class="img-fluid"
                      src="../../static/assets/img/blog/post-img2.jpg"
                      alt=""
                    />
                  </div>
                ...
                >
                  <div class="thumb">
                    <a href="#"
                      ><img
                        class="img-fluid"
                        src="../../static/assets/img/blog/prev.jpg"
                        alt=""
                    /></a>
                  </div>
                  <div class="arrow">
                ...
                >
                  ...
                  <div class="thumb">
                    <a href="#"
                      ><img
                        class="img-fluid"
                        src="../../static/assets/img/blog/next.jpg"
                        alt=""
                    /></a>
                  </div>
                </div>
            ...
            <div class="comments-area">
              ...
              <div class="comment-list">
                <div class="single-comment justify-content-between d-flex">
                  <div class="user justify-content-between d-flex">
                    <div class="thumb">
                      <img src="../../static/assets/img/blog/c1.jpg" alt="" />
                    </div>
                    <div class="desc">
              ...
              <div class="comment-list left-padding">
                <div class="single-comment justify-content-between d-flex">
                  <div class="user justify-content-between d-flex">
                    <div class="thumb">
                      <img src="../../static/assets/img/blog/c2.jpg" alt="" />
                    </div>
                    <div class="desc">
              ...
              <div class="comment-list left-padding">
                <div class="single-comment justify-content-between d-flex">
                  <div class="user justify-content-between d-flex">
                    <div class="thumb">
                      <img src="../../static/assets/img/blog/c3.jpg" alt="" />
                    </div>
                    <div class="desc">
              ...
              <div class="comment-list">
                <div class="single-comment justify-content-between d-flex">
                  <div class="user justify-content-between d-flex">
                    <div class="thumb">
                      <img src="../../static/assets/img/blog/c4.jpg" alt="" />
                    </div>
                    <div class="desc">
              ...
              <div class="comment-list">
                <div class="single-comment justify-content-between d-flex">
                  <div class="user justify-content-between d-flex">
                    <div class="thumb">
                      <img src="../../static/assets/img/blog/c5.jpg" alt="" />
                    </div>
                    <div class="desc">
            ...
            <div class="blog_right_sidebar">
              ...
              <aside class="single_sidebar_widget popular_post_widget">
                ...
                <div class="media post_item">
                  <img
                    src="../../static/assets/img/blog/popular-post/post1.jpg"
                    alt="post"
                  />
                  <div class="media-body">
                    <router-link :to="{ name: 'SingleBlog' }"
                      ><h3>Space The Final Frontier</h3></router-link
                    >
                    <p>02 Hours ago</p>
                  </div>
                </div>
                <div class="media post_item">
                  <img
                    src="../../static/assets/img/blog/popular-post/post2.jpg"
                    alt="post"
                  />
                  <div class="media-body">
                    <router-link :to="{ name: 'SingleBlog' }"
                      ><h3>The Amazing Hubble</h3></router-link
                    >
                    <p>02 Hours ago</p>
                  </div>
                </div>
                <div class="media post_item">
                  <img
                    src="../../static/assets/img/blog/popular-post/post3.jpg"
                    alt="post"
                  />
                  <div class="media-body">
                    <router-link :to="{ name: 'SingleBlog' }"
                      ><h3>Astronomy Or Astrology</h3></router-link
                    >
                    <p>03 Hours ago</p>
                  </div>
                </div>
                <div class="media post_item">
                  <img
                    src="../../static/assets/img/blog/popular-post/post4.jpg"
                    alt="post"
                  />
                  <div class="media-body">
                    <router-link :to="{ name: 'SingleBlog' }"
                      ><h3>Asteroids telescope</h3></router-link
                    >
                    <p>01 Hours ago</p>
                  </div>
                </div>
              ...
              <aside class="single_sidebar_widget ads_widget">
                <a href="#"
                  ><img
                    class="img-fluid"
                    src="../../static/assets/img/blog/add.jpg"
                    alt=""
                /></a>
                <div class="br"></div>
              </aside>
